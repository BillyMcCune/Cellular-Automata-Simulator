...
public class ModelHandler {
   ...
   */
  public ModelHandler(ConfigInfo configInfo) {
   ...
   */
  public void resetModel() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
    try {
      ...
      myNeighborCalculator = new NeighborCalculator<>(getGridShape(),getNeighborType(), getEdgeType());
